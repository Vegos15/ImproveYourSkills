...
public class AddNoteActivity extends AppCompatActivity {
    public static final String EXTRA_ID = "package com.example.my_mvvm_try.EXTRA_ID";
    public static final String EXTRA_NAME = "package com.example.my_mvvm_try.EXTRA_NAME";
    public static final String EXTRA_BORN = "package com.example.my_mvvm_try.EXTRA_BORN";
    public static final String EXTRA_FROM = "package com.example.my_mvvm_try.EXTRA_FROM";
    public static final String EXTRA_LOCATION = "package com.example.my_mvvm_try.EXTRA_LOCATION";
    public static final String EXTRA_STUDIES = "package com.example.my_mvvm_try.EXTRA_STUDIES";
    public static final String EXTRA_PHONE = "package com.example.my_mvvm_try.EXTRA_PHONE";
    public static final String EXTRA_BIOGRAPHY = "package com.example.my_mvvm_try.EXTRA_BIOGRAPHY";
